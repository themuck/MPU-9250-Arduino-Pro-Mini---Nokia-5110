...
void setup()
{
  ...
  display.setContrast(41); // Set the contrast
...
// Set up for data display
  ...
  if (readByte(MPU9250_ADDRESS, WHO_AM_I_MPU9250) == 0x71) // WHO_AM_I should always be 0x68
  {   
	  
	  display.setCursor(20,0); display.print("MPU9250");
	  display.setCursor(0,10); display.print("I AM");
	  display.setCursor(0,20); display.print(readByte(MPU9250_ADDRESS, WHO_AM_I_MPU9250), HEX);
   ...
   {   display.clearDisplay();
	   display.setCursor(0,0); display.print("not connected!");
	   display.display();
...
{  
 ...
 //yaw   -= 13.8; // Declination at Danville, California is 13 degrees 48 minutes and 47 seconds on 2014-04-04
   roll  *= 180.0f / PI;
	...
	display.setCursor(0,  0); display.print((int)(mx));
	display.setCursor(0, 8); display.print((int)(my));
	display.setCursor(0, 16); display.print((int)(mz));
	display.setCursor(0, 24); display.print("mG");
	
	display.setCursor(30,  0); display.print((int)yaw);
